...
- Moved the "Quick Start" section from the beginning of `LAIA.md` to the end of the document to prioritize architectural design and sandbox containment strategy.
